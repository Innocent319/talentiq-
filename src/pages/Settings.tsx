              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none bg-white text-gray-900"
                  />
                </div>
                <div>
          ...
          {activeSection === 'appearance' && (
            <div className="card p-6 space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-500">Customize how the app looks on your device</p>
              </div>
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500 outline-none bg-white text-gray-900">
